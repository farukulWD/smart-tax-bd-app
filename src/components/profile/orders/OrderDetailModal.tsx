        ...
        <ScrollView contentContainerStyle={{ padding: 16 }} showsVerticalScrollIndicator={false}>
          {selectedOrder && (
            <View className="gap-4">
              ...
              {selectedOrder.tax_types?.length > 0 && (
                <View className="rounded-3xl border border-border bg-card p-5">
                  <AppText className="mb-3 text-base font-bold text-foreground">Tax Types</AppText>
                  <View className="flex-row flex-wrap gap-1.5">
                    {selectedOrder.tax_types.map((value) => (
                      <View key={value} className="rounded-lg bg-muted px-3 py-1.5">
